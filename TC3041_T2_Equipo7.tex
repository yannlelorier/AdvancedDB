...
Decidimos realizar una tabla que representara a la poblacion mundial.Con el siguiente query se realizó la estructura de la tabla para cada una de las dbms. Conteniendo 4 columnas: el id, la edad de la persona, el nombre y su país de nacimiento. 
